...
from tile import *
from character import Direction, Man, Enemy, Object, FoodType, Food
                    ...
                    for idx, enemy in enumerate(self.enemies):                        
                        if enemy.x == attacked_cell[0] and enemy.y == attacked_cell[1]:
                            ...
                            if enemy.hitpoints <= 0:
                                ...
                                # レベルアップ判定
                                while self.ego.exp > self.exp_table[self.ego.lv+1]:
                                    self.ego.level_up()
                                    # 音でもならす
        ...
        for i in range(16):
            for j in range(16):
                ...
                #     draw_tile(x, y, TyleType.WALL_CORRIDER_DOWN)
                    ...
                    draw_tile(x, y, TyleType.WALL_IN_DR_CORNER_ONE)
